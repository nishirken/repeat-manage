...
var author$project$AddSymbol$Model = function (symbol) {
	return {symbol: symbol};
};
var author$project$AddSymbol$initialModel = author$project$AddSymbol$Model('');
var author$project$ChangeSpeed$Model = function (speed) {
	return {speed: speed};
};
var author$project$ChangeSpeed$defaultSpeed = 3000;
var author$project$ChangeSpeed$initialModel = author$project$ChangeSpeed$Model(author$project$ChangeSpeed$defaultSpeed);
var author$project$Common$StoredModel = F2(
	function (speed, symbols) {
		return {speed: speed, symbols: symbols};
	});
...
var author$project$LocalStorage$defaultModel = A2(author$project$Common$StoredModel, author$project$ChangeSpeed$defaultSpeed, _List_Nil);
...
var author$project$LocalStorage$modelDecoder = A3(
	elm$json$Json$Decode$map2,
	author$project$Common$StoredModel,
	A2(elm$json$Json$Decode$field, 'speed', elm$json$Json$Decode$int),
	A2(
...
var author$project$Slider$MakeInitialList = {$: 'MakeInitialList'};
...
var author$project$Slider$delay = F2(
	function (time, msg) {
		return A2(
			elm$core$Task$perform,
			function (_n0) {
...
var author$project$Slider$initialCmd = A2(author$project$Slider$delay, 500, author$project$Slider$MakeInitialList);
var author$project$Common$sliderSize = 5;
var author$project$Slider$Model = F4(
	function (speed, symbols, viewSymbols, randomSymbol) {
		return {randomSymbol: randomSymbol, speed: speed, symbols: symbols, viewSymbols: viewSymbols};
	});
var author$project$Slider$initialModel = A4(
	author$project$Slider$Model,
	0,
	_List_Nil,
	A2(
		elm$core$List$map,
		...
		A2(elm$core$List$range, 0, author$project$Common$sliderSize - 1)),
	'');
var author$project$SymbolsList$Model = function (symbols) {
	return {symbols: symbols};
};
var author$project$SymbolsList$initialModel = author$project$SymbolsList$Model(_List_Nil);
var elm$core$Platform$Cmd$map = _Platform_map;
var author$project$Main$init = function (_n0) {
	var storageState = _n0.storageState;
	var _n1 = author$project$LocalStorage$decodeModel(storageState);
	var speed = _n1.speed;
	var symbols = _n1.symbols;
	return _Utils_Tuple2(
		{
			addSymbolModel: author$project$AddSymbol$initialModel,
			changeSpeedModel: function () {
				var m = author$project$ChangeSpeed$initialModel;
				return _Utils_update(
					m,
					{speed: speed});
			}(),
			sliderModel: function () {
				var m = author$project$Slider$initialModel;
				return _Utils_update(
					m,
					{speed: speed, symbols: symbols});
			}(),
			symbolsListModel: function () {
				var m = author$project$SymbolsList$initialModel;
				return _Utils_update(
					m,
					{symbols: symbols});
			}()
		},
		A2(elm$core$Platform$Cmd$map, author$project$Main$SliderMsg, author$project$Slider$initialCmd));
};
var author$project$AddSymbol$update = F2(
	function (msg, model) {
		if (msg.$ === 'InputChanged') {
			var x = msg.a;
			return {symbol: x};
...
var author$project$Slider$MakeRandom = {$: 'MakeRandom'};
...
var author$project$Slider$fromIndex = F2(
	function (xs, i) {
		var _n0 = A2(
			elm$core$Array$get,
			i,
			elm$core$Array$fromList(xs));
		if (_n0.$ === 'Just') {
			var x = _n0.a;
			return x;
		} else {
...
var author$project$Slider$ranges = function (xs) {
	return _Utils_Tuple2(
		0,
		elm$core$List$length(xs) - 1);
};
...
var author$project$Slider$randomIndex = function (xs) {
	var _n0 = author$project$Slider$ranges(xs);
	var fst = _n0.a;
	var snd = _n0.b;
	return A2(elm$random$Random$int, fst, snd);
};
...
var author$project$Slider$makeRandomList = F3(
	function (originalSymbols, msg, howMuch) {
		var generatedList = A2(
			elm$random$Random$list,
			howMuch,
			author$project$Slider$randomIndex(originalSymbols));
		return A2(
			elm$random$Random$generate,
			function (xs) {
				return msg(
					A2(
						elm$core$List$map,
						function (index) {
							return A2(author$project$Slider$fromIndex, originalSymbols, index);
						},
						xs));
			},
			generatedList);
	});
var author$project$Slider$RandomGenerated = function (a) {
	return {$: 'RandomGenerated', a: a};
};
var author$project$Slider$makeRandomSymbol = function (originalSymbols) {
	return A2(
		elm$random$Random$generate,
		function (i) {
			return author$project$Slider$RandomGenerated(
				A2(author$project$Slider$fromIndex, originalSymbols, i));
		},
		author$project$Slider$randomIndex(originalSymbols));
};
...
var author$project$Slider$update = F2(
	function (msg, model) {
		...
		switch (msg.$) {
			case 'MakeInitialList':
				return _Utils_Tuple2(
					model,
					elm$core$Platform$Cmd$batch(
						_List_fromArray(
							[
								A3(author$project$Slider$makeRandomList, model.symbols, author$project$Slider$FullListGenerated, author$project$Common$sliderSize)
							])));
			case 'MakeRandom':
				return _Utils_Tuple2(
					model,
					author$project$Slider$makeRandomSymbol(model.symbols));
					...
					_Utils_update(
						model,
						{
							viewSymbols: A2(
								...
								A2(
									elm$core$List$take,
									elm$core$List$length(model.viewSymbols) - 1,
									model.viewSymbols))
						}),
					delayRandomCmd);
			case 'FullListGenerated':
				var xs = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
...
var author$project$SymbolsList$update = F2(
	function (msg, model) {
		var symbol = msg.a;
		return {
			symbols: A2(
...
var author$project$Main$updateInnerMsg = F2(
	function (msg, model) {
		var _n0 = model;
		var sliderModel = _n0.sliderModel;
		var addSymbolModel = _n0.addSymbolModel;
		var symbolsListModel = _n0.symbolsListModel;
		var changeSpeedModel = _n0.changeSpeedModel;
		switch (msg.$) {
			case 'SliderMsg':
				var subMsg = msg.a;
				var _n2 = A2(author$project$Slider$update, subMsg, sliderModel);
				var updatedModel = _n2.a;
				var updatedCmd = _n2.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{sliderModel: updatedModel}),
					A2(elm$core$Platform$Cmd$map, author$project$Main$SliderMsg, updatedCmd));
			case 'AddSymbolMsg':
				var subMsg = msg.a;
				var updatedModel = A2(author$project$AddSymbol$update, subMsg, addSymbolModel);
				return _Utils_Tuple2(
					_Utils_update(
						model,
			...
			case 'SymbolsListMsg':
				var subMsg = msg.a;
				var updatedModel = A2(author$project$SymbolsList$update, subMsg, symbolsListModel);
				return _Utils_Tuple2(
					_Utils_update(
						model,
			...
			default:
				var subMsg = msg.a;
				var updatedModel = A2(author$project$ChangeSpeed$update, subMsg, changeSpeedModel);
				return _Utils_Tuple2(
					_Utils_update(
						model,
...
var author$project$Common$AddSymbol = function (a) {
	return {$: 'AddSymbol', a: a};
};
var author$project$Common$None = {$: 'None'};
var author$project$AddSymbol$outMsg = function (msg) {
	if (msg.$ === 'AddSymbol') {
		var x = msg.a;
		return author$project$Common$AddSymbol(x);
	} else {
	...
	return elm$json$Json$Encode$object(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'symbols',
				A2(elm$json$Json$Encode$list, elm$json$Json$Encode$string, symbols))
			]));
};
...
var author$project$Slider$PartOfListGenerated = function (a) {
	return {$: 'PartOfListGenerated', a: a};
};
var author$project$Slider$updateOutCmd = F2(
	function (msg, model) {
		if (msg.$ === 'DeleteSymbol') {
			var x = msg.a;
			return A3(
				author$project$Slider$makeRandomList,
				model.symbols,
				author$project$Slider$PartOfListGenerated,
				author$project$Common$sliderSize - elm$core$List$length(model.viewSymbols));
		} else {
...
var author$project$Main$updateOutCmd = F2(
	function (msg, _n0) {
		...
		var symbolsListModel = _n0.symbolsListModel;
		var changeSpeedModel = _n0.changeSpeedModel;
		var writeToLocalStorage = author$project$LocalStorage$writeModel(
			A2(author$project$Common$StoredModel, changeSpeedModel.speed, symbolsListModel.symbols));
		switch (msg.$) {
			case 'AddSymbol':
				...
				return elm$core$Platform$Cmd$batch(
					_List_fromArray(
						[
							...
							A2(
								author$project$Slider$updateOutCmd,
								author$project$Common$DeleteSymbol(x),
								sliderModel))
						]));
			case 'ChangeSpeed':
				return writeToLocalStorage;
...
var author$project$Slider$updateOutMsg = F2(
	function (globalMsg, model) {
		switch (globalMsg.$) {
			case 'DeleteSymbol':
				var x = globalMsg.a;
				var clearList = elm$core$List$filter(
					function (s) {
			...
			case 'AddSymbol':
				...
				return _Utils_update(
					model,
					{
						symbols: A2(elm$core$List$cons, x, model.symbols)
					});
			case 'ChangeSpeed':
				var x = globalMsg.a;
				return _Utils_update(
...
var author$project$SymbolsList$updateOutMsg = F2(
	function (globalMsg, model) {
		if (globalMsg.$ === 'AddSymbol') {
			var x = globalMsg.a;
			return _Utils_update(
				model,
				{
...
var author$project$Main$updateOutModel = F2(
	function (globalMsg, model) {
		return _Utils_update(
			model,
			{
				sliderModel: A2(author$project$Slider$updateOutMsg, globalMsg, model.sliderModel),
				symbolsListModel: A2(author$project$SymbolsList$updateOutMsg, globalMsg, model.symbolsListModel)
			});
	});
var author$project$SymbolsList$outMsg = function (msg) {
	var x = msg.a;
	return author$project$Common$DeleteSymbol(x);
};
var author$project$Main$updateOutMsg = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'SymbolsListMsg':
				var subMsg = msg.a;
				var msg_ = author$project$SymbolsList$outMsg(subMsg);
			...
			case 'AddSymbolMsg':
				var subMsg = msg.a;
				var msg_ = author$project$AddSymbol$outMsg(subMsg);
				var model_ = A2(author$project$Main$updateOutModel, msg_, model);
				return _Utils_Tuple2(
					model_,
					A2(author$project$Main$updateOutCmd, msg_, model_));
...
var author$project$AddSymbol$AddSymbol = function (a) {
	return {$: 'AddSymbol', a: a};
};
var author$project$AddSymbol$InputChanged = function (a) {
...
var author$project$Styles$buttonWrapper = A2(
...
var author$project$Styles$mainColor = rtfeldman$elm_css$Css$hex('ff5722');
...
var author$project$Styles$styledButton = A2(
	rtfeldman$elm_css$Html$Styled$styled,
	...
	_List_fromArray(
		[
			...
			rtfeldman$elm_css$Css$backgroundColor(author$project$Styles$mainColor),
			rtfeldman$elm_css$Css$borderWidth(
			rtfeldman$elm_css$Css$px(0)),
			rtfeldman$elm_css$Css$cursor(rtfeldman$elm_css$Css$pointer)
		]));
var author$project$Styles$mainFont = 'Sarabun';
var author$project$Styles$sndColor = rtfeldman$elm_css$Css$hex('ffecb3');
...
var author$project$Styles$styledInput = A2(
	rtfeldman$elm_css$Html$Styled$styled,
	...
	_List_fromArray(
		[
			...
			author$project$Styles$mainColor),
			A2(
			rtfeldman$elm_css$Css$padding2,
			rtfeldman$elm_css$Css$px(5),
			rtfeldman$elm_css$Css$px(12)),
			rtfeldman$elm_css$Css$backgroundColor(author$project$Styles$sndColor),
...
var author$project$AddSymbol$view = function (model) {
	return A2(
		author$project$Styles$buttonWrapper,
		_List_Nil,
		_List_fromArray(
			[
				A2(
				author$project$Styles$styledInput,
				_List_fromArray(
					[
						rtfeldman$elm_css$Html$Styled$Events$onInput(author$project$AddSymbol$InputChanged)
					]),
				_List_Nil),
				A2(
				author$project$Styles$styledButton,
				_List_fromArray(
					[
						rtfeldman$elm_css$Html$Styled$Events$onClick(
						author$project$AddSymbol$AddSymbol(model.symbol))
					]),
				_List_fromArray(
					[
...
var author$project$ChangeSpeed$onInputChange = F2(
	function (value, currentValue) {
		var intVal = elm$core$String$toInt(value);
		if (intVal.$ === 'Just') {
			var x = intVal.a;
			return author$project$ChangeSpeed$Change(x);
		} else {
			return author$project$ChangeSpeed$Change(currentValue);
		}
	});
...
var author$project$Styles$opacityTransition = _List_fromArray(
	[
...
var author$project$Styles$speedInput = A2(
	rtfeldman$elm_css$Html$Styled$styled,
	author$project$Styles$styledInput,
	A2(
		elm$core$List$append,
		...
		author$project$Styles$opacityTransition));
...
var author$project$ChangeSpeed$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				A2(
				author$project$Styles$speedInput,
				_List_fromArray(
					[
...
var author$project$Main$AddSymbolMsg = function (a) {
	return {$: 'AddSymbolMsg', a: a};
};
var author$project$Main$ChangeSpeedMsg = function (a) {
	return {$: 'ChangeSpeedMsg', a: a};
};
var author$project$Main$SymbolsListMsg = function (a) {
	return {$: 'SymbolsListMsg', a: a};
};
var author$project$Slider$innerSliderId = 'slider';
var author$project$Styles$calculate = F3(
	function (index, fstVal, sndVal) {
		return _Utils_eq(index, (author$project$Common$sliderSize - ((author$project$Common$sliderSize / 2) | 0)) - 1) ? fstVal : sndVal;
	});
var author$project$Styles$calculateFontSize = function (index) {
	return rtfeldman$elm_css$Css$px(
		A3(author$project$Styles$calculate, index, 130, 90));
};
var author$project$Styles$calculateOpacity = function (index) {
	return rtfeldman$elm_css$Css$num(
		A3(author$project$Styles$calculate, index, 1.0, 0.6));
};
var author$project$Styles$centerSize = 200;
...
var author$project$Styles$symbol = function (index) {
	return A2(
		rtfeldman$elm_css$Html$Styled$styled,
		rtfeldman$elm_css$Html$Styled$div,
		_List_fromArray(
			[
				...
				rtfeldman$elm_css$Css$px(author$project$Styles$centerSize)),
				rtfeldman$elm_css$Css$height(
				rtfeldman$elm_css$Css$px(author$project$Styles$centerSize)),
				rtfeldman$elm_css$Css$fontSize(
				author$project$Styles$calculateFontSize(index)),
				rtfeldman$elm_css$Css$paddingBottom(
				rtfeldman$elm_css$Css$em(0.3)),
				rtfeldman$elm_css$Css$opacity(
				author$project$Styles$calculateOpacity(index))
			]));
};
var author$project$Slider$makeSymbol = F2(
	function (index, s) {
		return A3(
			author$project$Styles$symbol,
			index,
			_List_Nil,
			_List_fromArray(
				[
...
var author$project$Styles$centerBorder = function () {
	var inCenter = A3(
		rtfeldman$elm_css$Css$calc,
		rtfeldman$elm_css$Css$pct(50),
		rtfeldman$elm_css$Css$minus,
		rtfeldman$elm_css$Css$px(author$project$Styles$centerSize / 2));
	return A2(
		rtfeldman$elm_css$Html$Styled$styled,
		rtfeldman$elm_css$Html$Styled$div,
		_List_fromArray(
			[
				...
				rtfeldman$elm_css$Css$top(inCenter),
				rtfeldman$elm_css$Css$left(inCenter),
				rtfeldman$elm_css$Css$width(
				rtfeldman$elm_css$Css$px(author$project$Styles$centerSize)),
				rtfeldman$elm_css$Css$height(
				rtfeldman$elm_css$Css$px(author$project$Styles$centerSize)),
...
var author$project$Styles$innerSlider = function (speed) {
	return A2(
		rtfeldman$elm_css$Html$Styled$styled,
		rtfeldman$elm_css$Html$Styled$div,
		_List_fromArray(
...
var author$project$Styles$slider = A2(
	rtfeldman$elm_css$Html$Styled$styled,
	...
	_List_fromArray(
		[
			...
			rtfeldman$elm_css$Css$width(
			rtfeldman$elm_css$Css$px(author$project$Styles$centerSize * author$project$Common$sliderSize)),
...
var author$project$Slider$view = function (model) {
	return A2(
		author$project$Styles$slider,
		_List_Nil,
		_List_fromArray(
			[
				A2(
				author$project$Styles$innerSlider(model.speed),
				_List_fromArray(
					[
						rtfeldman$elm_css$Html$Styled$Attributes$id(author$project$Slider$innerSliderId)
					]),
				A2(elm$core$List$indexedMap, author$project$Slider$makeSymbol, model.viewSymbols)),
				A2(author$project$Styles$centerBorder, _List_Nil, _List_Nil)
			]));
};
...
var author$project$Styles$asideList = A2(
	rtfeldman$elm_css$Html$Styled$styled,
	...
	A2(
		...
		author$project$Styles$opacityTransition));
var author$project$Styles$bgColor = rtfeldman$elm_css$Css$hex('fff3e0');
var rtfeldman$elm_css$Css$margin = rtfeldman$elm_css$Css$prop1('margin');
var rtfeldman$elm_css$Css$padding = rtfeldman$elm_css$Css$prop1('padding');
var author$project$Styles$reset = _List_fromArray(
	[
...
var author$project$Styles$globalStyles = rtfeldman$elm_css$Css$Global$global(
	_List_fromArray(
		[
			rtfeldman$elm_css$Css$Global$everything(author$project$Styles$reset),
			...
			_List_fromArray(
				[
					...
					rtfeldman$elm_css$Css$backgroundColor(author$project$Styles$bgColor),
					rtfeldman$elm_css$Css$fontFamilies(
					_List_fromArray(
						[author$project$Styles$mainFont]))
				])),
...
var author$project$Styles$root = A2(
	rtfeldman$elm_css$Html$Styled$styled,
	rtfeldman$elm_css$Html$Styled$div,
	_List_fromArray(
		[
...
var author$project$Styles$listItemWrapper = A2(
	rtfeldman$elm_css$Html$Styled$styled,
	author$project$Styles$buttonWrapper,
	_List_fromArray(
		[
...
var author$project$SymbolsList$DeleteSymbol = function (a) {
	return {$: 'DeleteSymbol', a: a};
};
var author$project$SymbolsList$symbolView = function (symbol) {
	return A2(
		author$project$Styles$listItemWrapper,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						rtfeldman$elm_css$Html$Styled$Events$onClick(
						author$project$SymbolsList$DeleteSymbol(symbol))
					]),
				_List_fromArray(
					[
...
var author$project$SymbolsList$view = function (_n0) {
	var symbols = _n0.symbols;
	return A2(
		rtfeldman$elm_css$Html$Styled$div,
		_List_Nil,
		A2(elm$core$List$map, author$project$SymbolsList$symbolView, symbols));
};
...
var author$project$Main$view = function (_n0) {
	...
	return {
		body: A2(
			...
			_List_fromArray(
				[
					author$project$Styles$globalStyles,
					A2(
					author$project$Styles$root,
					_List_Nil,
					_List_fromArray(
						[
							A2(
							rtfeldman$elm_css$Html$Styled$map,
							author$project$Main$ChangeSpeedMsg,
							author$project$ChangeSpeed$view(changeSpeedModel)),
							A2(
							rtfeldman$elm_css$Html$Styled$map,
							author$project$Main$SliderMsg,
							author$project$Slider$view(sliderModel)),
							A2(
							author$project$Styles$asideList,
							_List_Nil,
							_List_fromArray(
								[
									A2(
									rtfeldman$elm_css$Html$Styled$map,
									author$project$Main$AddSymbolMsg,
									author$project$AddSymbol$view(addSymbolModel)),
									A2(
									rtfeldman$elm_css$Html$Styled$map,
									author$project$Main$SymbolsListMsg,
									author$project$SymbolsList$view(symbolsListModel))
								]))
						]))
				])),
		title: 'Repeat'
...
_Platform_export({'Main':{'init':author$project$Main$main(
	A2(
		...
		A2(elm$json$Json$Decode$field, 'storageState', elm$json$Json$Decode$string)))(0)}});}(this));